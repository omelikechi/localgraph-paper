...
result_path = f'../results/eqi_glasso.pkl'
adjusted_path = '../results/eqi_glasso_adjusted.graphml'
graph_name = f'eqi_glasso_dpi{dpi}'

# layout and plot settings
radius = 4 if plot_adjusted_layout else 4
node_size = 3000
font_size = 8
figsize = (16,9)
edge_digits = 3
